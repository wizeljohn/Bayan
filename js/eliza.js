/*==========================================================
		...
		$(document).ready(function(){
			...
			$("#frmSignUp").on('submit',(function(e) {
	            e.preventDefault();
	            $.ajax({
	                url: "http://bayansell.esy.es/bayansell/signup.php",
	                type: "POST",
			...
			$('#btnLogin').click(function(){
				$.ajax({
					type:'GET',
					url:'http://bayansell.esy.es/bayansell/login.php',
					dataType:'html',
					...
					$.ajax({
						type: 'GET',
						url:'http://bayansell.esy.es/bayansell/BuyItem.php',
						dataType:'html',
						data:"user="+user,
						success: function(data){
							if(data){
					...
					$.ajax({
						type: 'GET',
						url:'http://bayansell.esy.es/bayansell/profile.php',
						dataType: 'html',
					...
					$.ajax({
						type: 'GET',
						url:'http://bayansell.esy.es/bayansell/SellItem.php',
						dataType:'html',
						data:"user="+user,
						success: function(data){
							if(data){
				...
				$.ajax({
					type : 'POST',
					url : 'http://bayansell.esy.es/bayansell/checkuser.php',
							data : {
			...
			$.ajax({
				type: 'GET',
				url:'http://bayansell.esy.es/bayansell/mobile&tablet.php',
				dataType:'html',
				data: {},
				success: function(data){
					if(data){
			...
			$.ajax({
				type: 'GET',
				url:'http://bayansell.esy.es/bayansell/computer&laptop.php',
				dataType:'html',
				data: {},
				success: function(data){
					if(data){
			...
			$.ajax({
				type: 'GET',
				url:'http://bayansell.esy.es/bayansell/shoes&bags.php',
				dataType:'html',
				data: {},
				success: function(data){
					if(data){
			...
			$.ajax({
				type: 'GET',
				url:'http://bayansell.esy.es/bayansell/appliances.php',
				dataType:'html',
				data: {},
				success: function(data){
					if(data){
			...
			$.ajax({
				type: 'GET',
				url:'http://bayansell.esy.es/bayansell/watches.php',
				dataType:'html',
				data: {},
				success: function(data){
					if(data){
			...
			$.ajax({
				type: 'GET',
				url:'http://bayansell.esy.es/bayansell/cameras.php',
				dataType:'html',
				data: {},
				success: function(data){
					if(data){
			...
			$.ajax({
				type: 'GET',
				url:'http://bayansell.esy.es/bayansell/clothing.php',
				dataType:'html',
				data: {},
				success: function(data){
					if(data){
			...
			$.ajax({
				type: 'GET',
				url:'http://bayansell.esy.es/bayansell/books.php',
				dataType:'html',
				data: {},
				success: function(data){
					if(data){
			...
			$.ajax({
				type: 'GET',
				url:'http://bayansell.esy.es/bayansell/foods.php',
				dataType:'html',
				data: {},
				success: function(data){
					if(data){
			...
			$.ajax({
				type: 'GET',
				url:'http://bayansell.esy.es/bayansell/others.php',
				dataType:'html',
				data: {},
				success: function(data){
					if(data){
			...
			$("#frmMobile").on('submit',(function(i) {	
	            ...
	            i.preventDefault();
	            $.ajax({
	                url: "http://bayansell.esy.es/bayansell/additem.php",
	                type: "POST",
	                data:  new FormData(this),
	                contentType: false,
	                cache: false,
